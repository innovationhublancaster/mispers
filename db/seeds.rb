...
Message.create(content: "4 [YOU 10:01 am]: Hey, I'm not sure, my mum might not let me xxx.", order: 4, story_id: 1)

Message.create(content: "5 [NARRATOR]: Over the course of the day, Kev increased the pressure on Stacey.", order: 5, story_id: 1)
Message.create(content: "6 [KEV 10:30 am]: Your mum doesnt need to know, lie to her and say your staying at a friends house, come on! xxx.", order: 6, story_id: 1)
...
Message.create(content: "9 [YOU 11:00 am]: Okay then Kev, I'll come. Where is your house? xxx.", order: 9, story_id: 1)
...
Message.create(content: "12 [MUM 08:00 pm]: Stacey please can you reply, i'm getting worried....", order: 12, story_id: 1)
...
Message.create(content: "14 [MUM 10:00 pm]: What is going on, where are you???", order: 14, story_id: 1)
